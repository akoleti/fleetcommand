    ...
    <div>
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Search by truck, vendor..."
            value={searchQuery}
                  ...
                  return (
                    <tr key={record.id} className="hover:bg-slate-50/50 transition-colors">
                      <td className="whitespace-nowrap py-4 pl-5 pr-3">
                        <Link href={`/trucks/${record.truck.id}`} className="group">
                ...
                {records.length === 0 && (
                  <tr>
                    <td colSpan={7} className="py-16 text-center">
                      ...
                      <p className="mt-1 text-xs text-slate-400">Try adjusting your filters or schedule new maintenance.</p>
                    </td>
                  </tr>
                )}
              </tbody>
